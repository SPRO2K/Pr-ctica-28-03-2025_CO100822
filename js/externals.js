...
const init = () =>{
    ...
    if(typeof MediaRecorder === "undefined" || !tieneSoporteUserMedia()){
        return alert("Su navegador no cumple con los requisitos, por favor actualice a un navegador más reciente");
    }
    ...
    const segundosATiempo = numeroDeSegundos => {
        ...
        if(numeroDeSegundos<10) numer = "0"+numeroDeSegundos;
